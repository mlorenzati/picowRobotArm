...
## Acknowledgements
This work applied all the knwoledge and basis present in the 2 following project, I just integrated and adapted the work for a 6DOF arm based on SG90 and MGR996R servos, all recognition and credits for them.

[iotdesignshop mediapipe-robot-arm-controller](https://github.com/iotdesignshop/mediapipe-robot-arm-controller)
[Media Pipe UR5 robot tracking system from Brevin Banks](https://github.com/Brevinbanks/ur5_mediapipe_motion)